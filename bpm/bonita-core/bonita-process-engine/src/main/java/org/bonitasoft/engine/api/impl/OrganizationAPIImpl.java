...
public class OrganizationAPIImpl {
    ...
    private void updateActorProcessDependenciesForAllActors(final TenantServiceAccessor tenantAccessor) throws SBonitaException {
        ...
        final ActorBusinessArchiveDependencyManager dependencyResolver = new ActorBusinessArchiveDependencyManager(tenantAccessor.getActorMappingService(),tenantAccessor.getIdentityService(), tenantAccessor.getXMLWriter(), tenantAccessor.getTechnicalLoggerService());
        do {
